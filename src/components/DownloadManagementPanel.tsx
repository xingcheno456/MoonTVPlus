    ...
    <>
      {createPortal(
        <div className='fixed inset-0 z-[9999] flex items-center justify-center p-4'>
          ...
          <div className='relative flex max-h-[90vh] w-full max-w-4xl flex-col rounded-lg bg-white shadow-xl dark:bg-gray-900'>
            {/* Header */}
            ...
            <div className='flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700'>
              ...
              <button
                ...
                className='flex items-center gap-2 rounded bg-red-500 px-4 py-2 text-sm text-white transition-colors hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-50'
              >
