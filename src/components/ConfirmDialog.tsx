    ...
    <div className='fixed inset-0 z-[10000] flex items-center justify-center p-4'>
      ...
      <div className='relative w-full max-w-md rounded-lg bg-white shadow-xl dark:bg-gray-900'>
        ...
        <div className='flex items-center justify-end gap-3 border-t border-gray-200 p-4 dark:border-gray-700'>
          <button
            onClick={onCancel}
            className='rounded bg-gray-100 px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700'
          >
            {cancelText}
          </button>
          <button
            onClick={onConfirm}
            className={`rounded px-4 py-2 text-sm text-white transition-colors ${styles.button}`}
          >
            {confirmText}
          </button>
        </div>
