      ...
      <div className='rounded-[28px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950'>
        ...
        <div className='space-y-3'>
          {Array.from({ length: 8 }).map((_, index) => (
            <div
              key={index}
              className='rounded-2xl border border-gray-200 px-4 py-3 dark:border-gray-700'
            >
    ...
    <div className='space-y-6'>
      <div className='grid gap-6 rounded-[28px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950 md:grid-cols-[260px_1fr]'>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex flex-wrap gap-3'>
            ...
            <button
              onClick={toggleShelf}
              className='rounded-2xl border border-gray-200 px-5 py-3 text-sm font-medium text-gray-700 transition hover:border-sky-300 hover:text-sky-600 dark:border-gray-700 dark:text-gray-200'
            >
              {shelf[key] ? '移出书架' : '加入书架'}
            </button>
          </div>
      ...
      <div className='rounded-[28px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950'>
        <div className='mb-4 flex items-center justify-between'>
          ...
          >
            {descOrder ? (
              <ArrowDownWideNarrow className='inline h-4 w-4' />
            ) : (
              <ArrowUpWideNarrow className='inline h-4 w-4' />
            )}{' '}
            {descOrder ? '倒序' : '正序'}
          </button>
        </div>
